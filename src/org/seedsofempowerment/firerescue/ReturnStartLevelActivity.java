...
* All rights reserved
* filename : ReturnStartLevel.java
* description : When the user press the return button                            
* 
...
public class ReturnStartLevelActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.returnstartlevellayout);
		...
		okButton.setOnTouchListener(new OnTouchListener(){
 			...
 			public boolean onTouch(View v, MotionEvent event) {
 				if(event.getAction() == MotionEvent.ACTION_DOWN){
 					...
 					FireRescueGamming.fireman.setLevel(FireRescueGamming.fireman.getStartlevel());
 					FireRescueGamming.fireman.setCurrentLevel(0);
 					--(GameInfo.returnNumber);
 					ReturnStartLevelActivity.instance.finish();
 				}
 				return false;
 			}
         });
